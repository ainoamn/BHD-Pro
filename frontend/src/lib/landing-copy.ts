...
export const landingCopy = {
  ar: {
    ...
    craftTitle: "طابع محلي، أفق إقليمي",
    craftBody:
      "هوية بصرية مستوحاة من أرض عُمان — بألوانها وهندستها — لمنصة تخدم أعمالك أينما كنت في المنطقة.",
  },
  en: {
    brand: "Hisaby",
    brandEn: "حسابي",
    ...
    craftTitle: "Local character, regional reach",
    craftBody:
      "A visual identity rooted in Oman’s land, color, and geometry — for a platform that serves your business wherever you are in the region.",
  },
} as const;
