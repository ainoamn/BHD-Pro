...
export const landingCopy = {
  ar: {
    ...
    customersSub: "شعارات المشتركين المدفوعين تظهر تلقائياً بعد تفعيل الاشتراك ورفع الشعار.",
  ...
  en: {
    ...
    customersSub: "Paid subscribers appear here automatically after checkout and logo upload.",
