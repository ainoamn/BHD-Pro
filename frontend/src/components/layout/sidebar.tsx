...
export function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        "fixed right-0 top-0 h-screen bg-slate-900/95 backdrop-blur-xl border-l border-slate-800/50 z-50 transition-all duration-300 ease-in-out",
    ...
    >
      ...
      <nav className="px-3 py-4 space-y-1 border-t border-slate-800/50">
      ...
      <div className="absolute bottom-0 right-0 left-0 p-4 border-t border-slate-800/50">
