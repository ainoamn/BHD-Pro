...
**الحالة:** واتساب Cloud API **مفعّل حياً** (`whatsappMode: live` · قالب `pos_receipt`) · **الوصول للجوال ما زال مفتوحاً** (فواتير وإيصالات).  
**جاهزية الإنتاج + ملاحظات مفتوحة:** [`HISABY-OPS-READINESS-AND-OPEN-ISSUES-2026-08-10.md`](./HISABY-OPS-READINESS-AND-OPEN-ISSUES-2026-08-10.md)  
**حادثة «تم الإرسال ولا يصل» (تقنية):** [`HISABY-FIX-WHATSAPP-DELIVERY-2026-07-29.md`](./HISABY-FIX-WHATSAPP-DELIVERY-2026-07-29.md)
...
| السؤال | الجواب |
|--------|--------|
| هل Hisaby يرسل واتساب تلقائياً؟ | **يحاول** بعد ضبط Meta + قالب — كاشير + فواتير محاسبة عند `SENT`/`PAID` |
| هل «تم الإرسال» = وصل للجوال؟ | **لا.** = قبول Graph. **حتى 2026-08-10: الفواتير والإيصالات لا تصل للجوال** |
...
**حالة مفتوحة:** راجع [`HISABY-OPS-READINESS-AND-OPEN-ISSUES-2026-08-10.md`](./HISABY-OPS-READINESS-AND-OPEN-ISSUES-2026-08-10.md) §4 (واتساب) ثم طابق القالب واختبر `/integrations`.
