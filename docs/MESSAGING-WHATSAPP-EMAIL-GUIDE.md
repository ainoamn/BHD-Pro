...
| القناة | الحدث |
|--------|--------|
| **كاشير** | بعد البيع / الإلغاء / الاسترداد · وزر «إعادة الإرسال الآن» |
...
بدون القالب المعتمد ستفشل الرسائل خارج نافذة 24 ساعة (رمز Meta شائع `#131047`). من الكاشير سيظهر الخطأ ويُفتح واتساب يدوياً كاحتياط.
