...
2. **الكود (Wave EM — منجز):** صدق أخطاء إعدادات/وصفات/تقارير/Expo/لوحة/QR — [`HISABY-WAVE-EM-RESTO-ADMIN-ERROR-HONESTY-2026-07-28.md`](./HISABY-WAVE-EM-RESTO-ADMIN-ERROR-HONESTY-2026-07-28.md) · قبله EL طوابير المطعم.  
