...
2. **الكود (Wave CQ — منجز):** إيقاظ API عند الدخول — [`HISABY-WAVE-CQ-LOGIN-API-WAKE-2026-07-28.md`](./HISABY-WAVE-CQ-LOGIN-API-WAKE-2026-07-28.md) · قبله CP صدق إشعار الحجز العام.  
