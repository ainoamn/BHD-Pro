...
| نظام مطاعم ومطبخ كامل مربوط بالمحاسبة/POS | **R1 منجز** — `/resto` + ربط `restoLinkedAt` + قائمة منتجات + صالة فارغة؛ R2+ حسب [`HISABY-RESTAURANT-KITCHEN-PLAN.md`](./HISABY-RESTAURANT-KITCHEN-PLAN.md) |
