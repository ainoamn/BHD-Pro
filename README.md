...
| الأصول الثابتة | سجل الأصول والقيم |
| الموظفين والرواتب | سجل الموظفين + مسير رواتب شهري |
...
- تقارير: **مركز تقارير** — مبيعات، مشتريات، VAT، مخزون، رواتب، دفتر أستاذ
- **تصدير CSV** و**طباعة** لجميع التقارير + قائمة الفواتير
- واجهة **متجاوبة للموبايل** — بطاقات فواتير، سندات، أوامر شراء + قائمة منزلقة
- **عروض أسعار** و**إشعارات دائنة** من نظرة عامة المحاسبة
- **مراكز التكلفة والمشاريع** على الفواتير مع ترحيل GL تحليلي
